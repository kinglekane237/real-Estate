    ...
    else if(reg.test(val_mail) === false)
    {
      ...
      fetch(url+'api_connexion.php',{
        ...
        body:JSON.stringify({
          ...
          email_inscription_L: val_mail,
          password_inscription_L: val_password,
          numero_inscription_L: val_numero,
          userName_inscription_L: val_userName,
          id_inscription: '1'
        })
...
<KeyboardAvoidingView style={styles.container} behavior="padding" enabled>
    <View  style ={styles.container}>
      ...
      <F_text_input
       ...
       onPress = {()=> navigation.navigate('Locataires')}
